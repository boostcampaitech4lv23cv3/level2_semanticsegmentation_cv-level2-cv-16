...
from .base.beit_win import BEiTWIN
...
class BEiTWINAdapter(BEiTWIN):
    def __init__(self, pretrain_size=224, conv_inplane=64, n_points=4, deform_num_heads=6,
                 init_values=0., inj_init_values=0., cffn_ratio=0.25, deform_ratio=1.0, with_cffn=True,
        ...
        self.interactions = nn.Sequential(*[
            InteractionBlock(dim=embed_dim, num_heads=deform_num_heads, n_points=n_points,
                             init_values=inj_init_values, drop_path=self.drop_path_rate,
