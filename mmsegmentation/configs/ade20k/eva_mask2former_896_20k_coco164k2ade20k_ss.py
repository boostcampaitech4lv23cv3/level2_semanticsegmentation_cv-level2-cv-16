...
load_from = '/opt/ml/input/code/level2_semanticsegmentation_cv-level2-cv-16/mmsegmentation/configs/ade20k/eva_sem_seg_mask2former_ade_ss61p5_ms62p3.pth'
model = dict(
    ...
    decode_head=dict(
        in_channels=[352, 352, 352, 352], ########################## [1408, 1408, 1408, 1408]
        feat_channels=1024,
        out_channels=1024,
        num_queries=200,
        pixel_decoder=dict(
...
data = dict(samples_per_gpu=1,  # we use a total bsz of 64
