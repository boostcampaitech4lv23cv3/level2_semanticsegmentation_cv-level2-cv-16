...
from .modeling.criterion import SeMaskSetCriterion, SeMaskRankSegSetCriterion, AsymmetricLoss
from .modeling.matcher import HungarianMatcher
from .modeling.multilabel_head import MultiLabelHead


@META_ARCH_REGISTRY.register()
class SeMaskMaskFormerRankSEG(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            # add mlseg(rankseg)
            "ml_use_gt": cfg.MODEL.RANKSEG.USE_GT, # ml_use_gt
            "ml_head": ml_head,
            "ml_loss": ml_loss,
            "ml_norm": ml_norm,
            "ml_loss_weight": ml_loss_weight,
            "ml_topk": cfg.MODEL.RANKSEG.TOPK, # ml_topk
        }
