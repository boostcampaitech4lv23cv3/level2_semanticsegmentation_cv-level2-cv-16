...
n_iter = 79999
pth_name = f'./output/model_00{n_iter}.pth'
k_fold = 0
...
def main():
    ...
    for file_name, string in zip(image_id, preds_array):
        submission = submission.append(
            ...
            ignore_index=True)
    submission.to_csv(os.path.join(root, 'submission', f'submission_{model_name}_iter{n_iter}_fold-{k_fold}-use_concat_in_for_loop.csv'), index=False)
