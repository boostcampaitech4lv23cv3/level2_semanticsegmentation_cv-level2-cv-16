...
for imgs, masks, image_infos in train_loader:
    ...
    file_dir = os.path.join(dataset_path, f"annotations/training/{image_infos['id']:04}.png")
...
for imgs, masks, image_infos in val_loader:
    image_infos = image_infos[0]
    file_dir = os.path.join(dataset_path,f"annotations/validation/{image_infos['id']:04}.png")
